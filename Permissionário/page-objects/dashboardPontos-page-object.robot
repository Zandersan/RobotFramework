...
${TEXT_RESULTADO_FILTRO}    xpath://html/body/div/div/div/main/section/div[5]/div[2]/div/div/div/div/span 
...
Verificar informações de Dashboard "Férias"
    ...
    Sleep    2
    Element Should Contain    ${TEXT_RESULTADO_FILTRO}    ${GET_FEIRAS_DIS}
    Select From List By Label    xpath://*[@id="Status"]    Ocupado
    Click Element    xpath://*[@id="btnFiltrarPontoComercial"]
    Sleep    2
    Element Should Contain    ${TEXT_RESULTADO_FILTRO}    ${GET_FEIRAS_OCP}
...
Verificar informações de Dashboard "Sacolões"
    ...
    Click Element    ${BUTTON_FILTRAR}
    Sleep    2
    Element Should Contain    ${TEXT_RESULTADO_FILTRO}    ${GET_SACOLOES_DIS}
    Select From List By Label    ${LIST_STATUS}    Ocupado
    Click Element    ${BUTTON_FILTRAR}
    Sleep    2
    Element Should Contain    ${TEXT_RESULTADO_FILTRO}    ${GET_SACOLOES_OCP}
...
Verificar informações de Dashboard "Mercado Municipal de Curitiba"
    ...
    Click Element    ${BUTTON_FILTRAR}
    Sleep    2
    Element Should Contain    ${TEXT_RESULTADO_FILTRO}    ${GET_MERC_CWB_DIS}
    Select From List By Label    ${LIST_STATUS}    Ocupado
    Click Element    ${BUTTON_FILTRAR}
    Sleep    2
    Element Should Contain    ${TEXT_RESULTADO_FILTRO}    ${GET_MERC_CWB_OCP}    
...
Verificar informações de Dashboard "Mercado Regional do Cajuru"
    ...
    Click Element    ${BUTTON_FILTRAR}
    Sleep    2
    Element Should Contain    ${TEXT_RESULTADO_FILTRO}    ${GET_MERC_CAJURU_DIS}
    Select From List By Label    ${LIST_STATUS}    Ocupado
    Click Element    ${BUTTON_FILTRAR}
    Sleep    2
    Element Should Contain    ${TEXT_RESULTADO_FILTRO}    ${GET_MERC_CAJURU_OCP}    
