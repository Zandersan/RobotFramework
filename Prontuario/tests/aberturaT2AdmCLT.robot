*** Settings ***
Resource    ..\\page-objects\\aberturaAtendimento-T2AdmCLT-page-object.robot

*** Test Cases ***
Realizar abertura de atendimento tipo "T2 Administrativo CLT" e validar regras do sistema
