...
Realizar abertura de atendimento tipo "Atestado"
    ...
    Select From List By Value    ${LIST_TIPO_ATENDIMENTO}    5
    List Selection Should Be    ${LIST_TIPO_ATENDIMENTO}    ATESTADO
...
Verificar Regra 4.4
    ...
    ${ANTERIOR_DATA_6}    Get Current Date    increment=-6 day    result_format=%d/%m/%Y
    ${DATA_HOJE}    Get Current Date    result_format=%d/%m/%Y
    Input Text    ${INPUT_DATA_INICIO}    ${ANTERIOR_DATA_6}
    Input Text    ${INPUT_DATA_FIM}    ${DATA_HOJE}
